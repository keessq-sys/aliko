      ...
      <div class="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8 shadow-2xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <label class="block">
            ...
            <input type="text" bind:value={cacRcNumber} class="w-full min-h-[44px] bg-black/40 border border-white/10 rounded-lg px-4 py-2 text-white focus:border-blue-500" placeholder="Optional" />
          </label>
          <label class="block">
            <span class="mb-1 block text-sm text-gray-400">Portfolio Size</span>
            <select bind:value={portfolioSize} class="w-full min-h-[44px] bg-black/40 border border-white/10 rounded-lg px-4 py-2 text-white focus:border-blue-500">
