<script lang="ts">
  ...
  import { LayoutDashboard, Map, FolderOpen, FileText, Construction, MessageSquare, Bell, ChevronRight, LogOut, Settings, Inbox, Building2, Briefcase, Layers, UserCog, Menu, X } from "lucide-svelte";
