  ...
  function handleInput(e: Event) {
    ...
    if (val.length > 0) {
      if (!val.startsWith('234')) {
        // Just formatting example, simplified
      }
    }
    value = val;
  }
...
<div class="flex w-full bg-stone-900 border border-stone-700 rounded-lg overflow-hidden focus-within:border-emerald-500 focus-within:ring-1 focus-within:ring-emerald-500 transition-all">
