<script lang="ts">
  ...
  export let message = "Hi, I'd like to chat with Aliko Diamond Key.";
</script>
...
>
  ...
  <span class="relative max-w-0 overflow-hidden whitespace-nowrap text-sm font-semibold transition-all duration-300 group-hover:max-w-[10rem]">
    Chat with us
  </span>
</a>
